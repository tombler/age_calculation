...
$(document).ready(function () {
	...
	$('#submit').click(function( event ){
		...
		if (birthYear === "" || birthMonth === "" || birthDay === "" || birthYear > thisYear || birthDay > 31) {
			alert("You don't know your birthday? Enter a valid month, day and year.")
		...
		if (dayOfMonth >= birthDay) {
			...
			daysOld = 31 - (birthDay - dayOfMonth); //This is inaccurate since months have different number of days.
		...
		villain.innerHTML = "Your nickname is: " + getVillainName(birthMonth, birthDay)

		$('#villain').after("<button class='button-align' id='refresh'>Enter Another Birthday</button>")
